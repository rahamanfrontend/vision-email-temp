        ...
        <Tailwind
            ...
            config={{
                theme: {
                    extend: {
                        colors: {
                            // TODO: need to inform rahman regarding color and theme issues
                            primary: '#ED2124',
                            secondary: '#5E6470',
                            info: '#1A1C21',
                            background: '#FEE9EA',
                        ...
                        <Section className="py-[24px] px-6 lg:px-[45px]">
                            <Section className="px-[37.5px] py-[32px] bg-white">
                                ...
                                <Text className="text-secondary text-base font-normal">
                                    Thank you for signing up with VIZFLEET! We
                                    just need to verify your email address to
                                ...
                                <Text className="text-info text-[20px] font-semibold flex my-6 ">
                                    OTP :{' '}
                                    <span
                                        className="text-primary ms-1 block "
                                        style={{
                                            marginLeft: '4px',
                                        }}>
                                        {otp ?? 'N/A'}
                                ...
                                <Button
                                    href={`${configs.FRONTEND_HOST}/verify-otp?token=${token}`}
                                ...
                                <Link
                                    ...
                                    {`${configs.FRONTEND_HOST}/verify-otp?token=${token}`}
                                </Link>
